...
?>
        <form
            ...
            method="post"
            action="edsimgejala.php"
            target="_self">
            <table
                style="border:1px solid #CCC; margin-top:150px;"
                width="509"
                border="0"
                cellpadding="3"
                cellspacing="0"
                ...
                <tr>
                    <td width="160" valign="top">
                        <span class="style35">Kode Gejala</span></td>
                    <td width="9">:</td>
                ...
                <tr>
                    ...
                    <td valign="top"><input type="submit" name="simpan" id="simpan" value="Update"/>
                        <a href="../admin/gejala.php"><input type="button" name="batal" id="batal" value="Batal"/></a>
                    </td>
                </tr>
                <tr>
                    <td valign="top">
