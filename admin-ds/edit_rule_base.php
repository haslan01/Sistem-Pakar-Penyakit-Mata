...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $('div.TxtKdPenyakit option[value="<?php echo $_GET['kdpenyakit'];?>').prop(
                    "selected",
                    true
                );
    ...
    <body>
        <form
            ...
            name="form1"
            method="post"
            action="update_kaidah_produksi.php"
            ...
            <div>
                <table
                    ...
                    bgcolor="#CCCC99">
                    <tr bgcolor="#FFFFFF">
                        <td style="background:linear-gradient(to top, #0CC, #09C);">Kode Rule :
                            <?php echo $_GET['kdpenyakit'];?></td>
                        <td style="background:linear-gradient(to top, #0CC, #09C);">
                            <strong>Edit Data Basis Pengetahuan</strong>
                        </td>
                    </tr>
                    <tr bgcolor="#FFFFFF">
                        <td colspan="2">
  ...
  ?><input
                                        type="hidden"
                                        name="TxtKdPenyakit"
                                        value="<?php echo $_GET['kdpenyakit'];?>"/></div>
                            </strong>
                        </td>
                    </tr>
                    <tr bgcolor="#FFFFFF">
                        <td>&nbsp;</td>
                        <td>
                            <a href="../admin/basis_pengetahuan.php"><input type="button" name="batal" id="batal" value="Batal"/></a><input type="submit" name="Submit" value="Update Rule"/></td>
                    </tr>
                </table>
            </div>
        </form>
