<?php include"header.php"; ?>
   ...
   ?>
	...
	?>
                                        ...
                                        <td>
                                            <a
                                                href="edpenyakit.php?kdubah=<?php echo $data['id'];?>"
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('.text').truncatable(
                {limit: 100, more: '[<strong style="color:red;">&raquo;&raquo;&raquo;</strong>]', less: true, hideText: '[<strong>&laquo;&laquo;&laquo;</strong>]'}
            );
        });
        // Line chart
